...
import com.treshermanitos.api.purchase.dto.ProductSold;
...
public interface PurchaseRepository extends JpaRepository<Purchase, Long> {
    @Query("SELECT NEW com.treshermanitos.purchase.dto.PurchaseDTO(" +
    ...
    @Query("SELECT NEW com.treshermanitos.purchase.dto.ProductSold( " +
