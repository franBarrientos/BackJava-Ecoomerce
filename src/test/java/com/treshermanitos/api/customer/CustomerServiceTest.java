...
class CustomerServiceTest {
    ...
    public void testCreateOne() {
        ...
        request.setUser(this.sharedCustomer.getUserEntity().getId()); // Set a valid user ID
    ...
    public void testCreateOneRelationshipAlreadyExists() {
        ...
        UserEntity userEntityWithExistingCustomer = new UserEntity();
        userEntityWithExistingCustomer.setId(1L);
        userEntityWithExistingCustomer.setCustomer(new Customer()); // Set an existing customer
        Mockito.when(userRepository.findByIdAndStateIsTrue(1L)).thenReturn(Optional.of(userEntityWithExistingCustomer));
